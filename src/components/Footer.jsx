...
const Footer = () => {
	return (
		<footer className="bg-gray-900 text-white py-16 px-4 sm:px-8 mt-10 mb-auto w-full">
			<div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-10 text-center sm:text-left">
				{/* Left Section - About */}
				<div className="space-y-4">
					<h3 className="text-xl font-bold">About Us</h3>
					<p className="text-sm text-gray-400 leading-relaxed">
						Industries Times is your go-to destination for stories that shape
						India's industrial future. We simplify marketing and elevate voices
					...
					<p className="text-sm text-gray-400">
						...
						>
							info@industriestimes.com
						</a>
					</p>
					<p className="text-sm text-gray-400">
						Contact us: <br />
						<a href="tel:+916230687883" className="hover:text-white">
							+91 6230687883
						</a>
					</p>
				</div>
